...
public enum InputFieldType: Hashable {
    case text(binding: Binding<String>, type: CustomTextFieldType)
    case date(binding: Binding<Date>, type: CustomTextFieldType, restriction: DateRestriction)
    case secure(binding: Binding<String>, type: CustomTextFieldType)
...
public struct STTextFieldList: View {
    ...
    public init(isFocusedOn: FocusState<CustomTextFieldType?>.Binding,
